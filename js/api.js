...
function testRankingData() {
    ...
    let data = [
        ...
        },
        {
            ...
            "currency": "Trx",
            "reward": 120.780000,
            "date": "2022-03-25 16:32:51"
        }
    ];
    showRankingTableBet(data);
}
